    ...
    <div className="bg-gradient-to-br from-blue-900 via-purple-900 to-black text-white min-h-screen p-8">
      ...
      <div className="flex gap-4 mb-12">
        <button
          ...
          className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-3 px-8 rounded-lg transition duration-300"
        >
          🚨 Report Issue
        </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-700 p-8 rounded-xl shadow-lg hover:scale-105 transition duration-300">
          <div className="text-5xl mb-2">✓</div>
          <div className="text-5xl font-bold mb-2">
            {metrics.issues_resolved}
          </div>
          <div className="text-lg text-gray-100">Issues Resolved</div>
          <div className="text-sm font-bold text-green-200 mt-3">
            ↑ 3x faster than baseline
          </div>
        </div>

        <div className="bg-gradient-to-br from-blue-500 to-cyan-600 p-8 rounded-xl shadow-lg hover:scale-105 transition duration-300">
          <div className="text-5xl mb-2">💧</div>
          <div className="text-4xl font-bold mb-2">
            {(metrics.environmental_impact.water_saved_liters / 1000).toFixed(1)}K
          </div>
          <div className="text-lg text-gray-100">Liters Saved</div>
          <div className="text-sm font-bold text-blue-200 mt-3">
            From leak fixes
          </div>
        </div>

        <div className="bg-gradient-to-br from-yellow-500 to-amber-600 p-8 rounded-xl shadow-lg hover:scale-105 transition duration-300">
          <div className="text-5xl mb-2">🌱</div>
          <div className="text-4xl font-bold mb-2">
            {metrics.environmental_impact.carbon_saved_kg}kg
          </div>
          <div className="text-lg text-gray-100">Carbon Saved</div>
          <div className="text-sm font-bold text-yellow-200 mt-3">
            From faster response
          </div>
        </div>

        <div className="bg-gradient-to-br from-purple-500 to-pink-600 p-8 rounded-xl shadow-lg hover:scale-105 transition duration-300">
          <div className="text-5xl mb-2">👥</div>
          <div className="text-4xl font-bold mb-2">
            {metrics.community_members.toLocaleString()}
          </div>
          <div className="text-lg text-gray-100">Citizens Engaged</div>
          <div className="text-sm font-bold text-purple-200 mt-3">
            Active community
          </div>
        </div>
          ...
          <div className="space-y-4">
            {metrics.top_issues?.map((issue, idx) => (
              ...
              >
                ...
                <span className="bg-blue-500 px-3 py-1 rounded font-bold">
                  {issue.count}
                </span>
              </div>
            ))}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-700 p-3 rounded">
              ...
              <p className="text-2xl font-bold text-green-400">
                {metrics.environmental_impact.pollution_reduction_percent}%
              </p>
            </div>
          </div>
        </div>
        ...
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            ...
            <Bar
              dataKey="water"
              fill="#3b82f6"
              name="Water Saved (K L)"
            />

            <Bar
              dataKey="carbon"
              fill="#f59e0b"
              name="Carbon Saved (10kg)"
            />
          </BarChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="text-center text-gray-400 text-sm border-t border-gray-700 pt-8">
        <p>
          Community Hero - Powered by Google AI Studio | Vibe2Ship 2026
        </p>

        <p className="mt-2">
          Real-time data from:
          <code className="bg-gray-800 px-2 py-1 rounded ml-2">
            community-hero-vibe2ship.onrender.com
          </code>
        </p>
      </div>
    </div>
